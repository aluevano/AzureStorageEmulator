...
{
	public class XFETableAuthenticationManager : AuthenticationManager
	{
		...
		private XFETableAuthenticationManager(IStorageManager manager)
		{
		...
		{
			AsyncIteratorContext<IAuthenticationResult> asyncIteratorContext = new AsyncIteratorContext<IAuthenticationResult>("XFETableAuthenticationManager.Authenticate", callback, state);
		...
		public static AuthenticationManager CreateAuthenticationManager(IStorageManager manager)
		{
			...
			return new XFETableAuthenticationManager(manager);
		}
